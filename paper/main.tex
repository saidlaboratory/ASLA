...
The ordering of selection rules is also stable under both scoring rules and
across all three metrics: projection is worst, while shared-exponent pooling and
single-scale ranking are comparable. What propagation changes is whether the
difference between them can be called significant, not which is larger.
